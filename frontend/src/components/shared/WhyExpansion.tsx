...
export function WhyExpansion({ transparency, label = "Why am I seeing this?" }: WhyExpansionProps) {
  return (
    <details className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-600">
      <summary className="cursor-pointer list-none font-medium text-slate-900">{label}</summary>
